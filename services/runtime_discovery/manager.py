...
_BINARY_TO_RUNTIME: dict[str, RuntimeType] = {
    ...
    "opencode-ai": RuntimeType.OPENCODE,
    "agy": RuntimeType.AGY_CLI,
    "ollama": RuntimeType.OLLAMA,
    "lmstudio": RuntimeType.LM_STUDIO,
    "lm-studio": RuntimeType.LM_STUDIO,
    "vllm": RuntimeType.VLLM,
    "crewai": RuntimeType.CREWAI,
    "autogen": RuntimeType.AUTOGEN,
    "manus": RuntimeType.MANUS,
    "openmanus": RuntimeType.OPENMANUS,
    "cursor": RuntimeType.CURSOR,
    "goose": RuntimeType.GOOSE,
    "interpreter": RuntimeType.OPEN_INTERPRETER,
    "open-interpreter": RuntimeType.OPEN_INTERPRETER,
    "python": RuntimeType.PYTHON,
    "python3": RuntimeType.PYTHON,
    "node": RuntimeType.NODEJS,
    "nodejs": RuntimeType.NODEJS,
    "cargo": RuntimeType.CARGO,
    "go": RuntimeType.GO,
...
_RUNTIME_DISPLAY_NAMES: dict[RuntimeType, str] = {
    ...
    RuntimeType.AGY_CLI: "AGY CLI",
    RuntimeType.OLLAMA: "Ollama",
    RuntimeType.LM_STUDIO: "LM Studio",
    RuntimeType.VLLM: "vLLM",
    RuntimeType.CREWAI: "CrewAI",
    RuntimeType.AUTOGEN: "AutoGen",
    RuntimeType.MANUS: "Manus",
    RuntimeType.OPENMANUS: "OpenManus",
    RuntimeType.CURSOR: "Cursor",
    RuntimeType.GOOSE: "Goose",
    RuntimeType.OPEN_INTERPRETER: "Open Interpreter",
    RuntimeType.PYTHON: "Python",
    RuntimeType.NODEJS: "Node.js",
    RuntimeType.CARGO: "Rust (Cargo)",
    RuntimeType.GO: "Go",
...
_RUNTIME_VENDORS: dict[RuntimeType, str] = {
    ...
    RuntimeType.OPENCODE: "OpenCode AI",
    RuntimeType.AGY_CLI: "Antigravity",
    RuntimeType.OLLAMA: "Ollama",
