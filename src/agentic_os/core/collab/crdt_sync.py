...
class RealtimeCRDTSync:
    ...
    def __init__(self) -> None:
        self._cursors: dict[str, UserCursor] = {
            "operator-main": UserCursor(
                "operator-main",
                "Principal Engineer (You)",
                "#6366f1",
                "src/agentic_os/core/swarm.py",
                42,
                10,
            ),
            "agent-architect": UserCursor(
                "agent-architect",
    ...
    def update_cursor(
        self, client_id: str, username: str, color: str, file_path: str, line: int, col: int
    ) -> UserCursor:
