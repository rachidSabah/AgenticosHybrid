...
class Topic(StrEnum):
    ...
    EXECUTION_STREAM_STARTED = "execution.stream_started"
    EXECUTION_STREAM_CHUNK = "execution.stream_chunk"
    EXECUTION_STREAM_FINISHED = "execution.stream_finished"
    EXECUTION_FALLBACK = "execution.fallback"
    EXECUTION_HEDGED = "execution.hedged"
    EXECUTION_QUORUM = "execution.quorum"
    EXECUTION_PARALLEL = "execution.parallel"
    EXECUTION_SPECULATIVE = "execution.speculative"
    EXECUTION_ABORTED = "execution.aborted"
    EXECUTION_PROGRESS = "execution.progress"
    EXECUTION_METRICS = "execution.metrics"
    EXECUTION_TRACE = "execution.trace"
    EXECUTION_PROVIDER_ERROR = "execution.provider_error"
    EXECUTION_PROVIDER_SUCCESS = "execution.provider_success"
    EXECUTION_SHADOW = "execution.shadow"
    EXECUTION_CANARY = "execution.canary"
    EXECUTION_IDEMPOTENT = "execution.idempotent"
    EXECUTION_SESSION_STARTED = "execution.session_started"
    EXECUTION_SESSION_COMPLETED = "execution.session_completed"

    # ── Aggregation topics (Phase 5.11) ──
    ...
    CONSENSUS_FAILED = "aggregation.consensus_failed"
    VOTE_CAST = "aggregation.vote_cast"
    WEIGHTED_VOTE = "aggregation.weighted_vote"
    MAJORITY_REACHED = "aggregation.majority_reached"
    QUORUM_REACHED = "aggregation.quorum_reached"
    CONFLICT_DETECTED = "aggregation.conflict_detected"
    CONFLICT_RESOLVED = "aggregation.conflict_resolved"
    MERGE_COMPLETED = "aggregation.merge_completed"
    ENSEMBLE_COMPLETED = "aggregation.ensemble_completed"
    AGGREGATION_PIPELINE_COMPLETED = "aggregation.pipeline_completed"
    RESPONSE_SELECTED = "aggregation.response_selected"
    QUALITY_SCORE_UPDATED = "aggregation.quality_score_updated"
    CONFIDENCE_UPDATED = "aggregation.confidence_updated"
    SIMILARITY_UPDATED = "aggregation.similarity_updated"
    AGGREGATION_TIMEOUT = "aggregation.timeout"
    AGGREGATION_CANCELLED = "aggregation.cancelled"
    AGGREGATION_RETRIED = "aggregation.retried"
