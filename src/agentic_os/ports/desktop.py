...
@runtime_checkable
class DesktopMenuPort(Protocol):
    """Native application menu interface."""
...
@runtime_checkable
class DesktopDatabasePort(Protocol):
    """Local database persistence interface."""
...
@runtime_checkable
class DesktopEventPublisherPort(Protocol):
    """Desktop lifecycle event publisher interface."""
    ...
    async def publish_notification_created(self, notification_id: str, title: str, level: str) -> None: ...
...
@runtime_checkable
class DesktopHardeningPort(Protocol):
    """Desktop hardening, diagnostics, and recovery interface."""
