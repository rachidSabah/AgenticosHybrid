...
export function PluginMarketplace() {
  ...
  return (
    <div className="grid h-full grid-cols-12 gap-4 p-4">
      <Panel title="Provider Plugins" subtitle={`${providers.length} loaded adapters`} className="col-span-7">
        <div className="grid grid-cols-2 gap-3">
          {providers.map((p) => (
            <div key={p.name} className="rounded-xl border border-border/60 p-3">
      ...
      <Panel title="Capability Catalog" subtitle={`${caps.length} capabilities`} className="col-span-5">
